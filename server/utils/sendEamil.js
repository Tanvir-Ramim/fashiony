...
const mailUtils = async (req, res) => {
  ...
  const verifyEmailLink = `${process.env.SERVER_URL}${process.env.BASE_URL_V1}/auth/verify/${verificationToken}`;
                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="width:138px;">
                                            <a href="https://fashiony.com" target="_blank">
                                    ...
                                    <tr>
                                      <td style="word-break:break-word;font-size:0px;padding:0px 0px 20px;" align="left">
                                        <div style="cursor:auto;color:#737F8D;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:16px;line-height:24px;text-align:left;">
                                          ...
                                          <p>
                                            Wow! Thanks for registering an account with Patranee! You're the coolest person in all the land.
                                          </p>
                                    ...
                                    <tr>
                                      <td style="word-break:break-word;font-size:0px;padding:0px;" align="center">
                                        <div style="cursor:auto;color:#99AAB5;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:12px;line-height:24px;text-align:center;">
                                          ...
                                          Developed by fashiony • 
                                          <a href="https://fashiony.com/" style="color:#1EB0F4;text-decoration:none;" target="_blank">
                                            Visit Website
                                          </a> • 
                                          <a href="https://m.facebook.com/fashiony.digital/" style="color:#1EB0F4;text-decoration:none;" target="_blank">
                                            @fashiony.digital
                                          </a>
                                        </div>
...
module.exports = { emailVerificationLink: mailUtils };
